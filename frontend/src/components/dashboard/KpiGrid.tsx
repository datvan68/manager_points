  ...
  const getKpis = () => {
    ...
    return [
      ...
      },
      {
        ...
        description: isTeacher ? (kpis.pendingMyReviewCount > 0 ? `${kpis.pendingMyReviewCount} hồ sơ chờ duyệt` : "Đã duyệt hết") : (kpis.studentAttentionCount > 0 ? `${kpis.studentAttentionCount} sinh viên có từ 3 lượt` : "Không có sinh viên vượt ngưỡng"),
        icon: Clock,

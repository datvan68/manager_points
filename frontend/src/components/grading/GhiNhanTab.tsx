        ...
        <table className="w-full text-left border-collapse min-w-max">
          <thead className="bg-[#F8FAFB] sticky top-0 z-10 shadow-sm shadow-gray-100/50">
            <tr>
              ...
              <th className="px-5 py-3 text-xs font-bold text-gray-500 uppercase tracking-wide border-b border-gray-100">Lần</th>
            ...
            {isLoading ? (
              Array.from({ length: itemsPerPage }).map((_, i) => (
                <tr key={i}>
                  ...
                  <td className="px-5 py-4 border-b border-gray-50"><Skeleton className="w-8 h-4" /></td>
                  <td className="px-5 py-4 border-b border-gray-50"><Skeleton className="w-24 h-4" /></td>

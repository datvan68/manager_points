...
const PopoverContent = React.forwardRef<
  ...
  PopoverContentProps
>(({ className, align = "center", sideOffset = 6, avoidCollisions = true, collisionPadding = 16, overlay = false, showCloseButton = false, centered = false, mobileCentered = false, children, ...props }, ref) => (
  <>
    {overlay && (
    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        data-mobile-centered={mobileCentered ? "" : undefined}
        className={cn(

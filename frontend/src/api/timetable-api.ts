...
export interface TimetableClassSelection { year: string; semester: string; faculty?: string; course?: string; className: string; weekCount?: number }
...
export const timetableApi = {
  ...
  async getSavedClassWeekStatus(selection: TimetableWeekSyncRequest) { return request<TimetableWeekSyncStatus>(`${API_BASE}/timetable/sync/class/week/status?${query({ ...classSyncPayload(selection), week: selection.week, })}`); },

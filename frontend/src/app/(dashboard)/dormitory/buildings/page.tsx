...
const roomDefaults = { room_code: '', room_name: '', building_id: '', floor: 1, room_type: 'Thường', bed_count: 1, room_price: 0, status: 'Trống', description: '' };
const buildingDefaults = { building_code: '', name: '', address: '', floor_count: 1, status: 'Active', description: '' };
...
const toRoomMutationPayload = (form: FormValue): RoomMutationInput => ({
  room_code: String(form.room_code ?? '').trim(),

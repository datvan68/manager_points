  ...
  return <RouteGuard><main className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
    <div className="w-full min-w-0 space-y-4">
      ...
      {isAdmin && <div role="tablist" aria-label="Thời khóa biểu" className="flex w-full gap-2 overflow-x-auto border-b border-slate-200">
        ...
        <button type="button" role="tab" aria-selected={activeTab === 'snapshots'} aria-controls="timetable-snapshots-panel" id="timetable-snapshots-tab" onClick={() => setActiveTab('snapshots')} className="whitespace-nowrap px-3 py-2 text-sm font-bold text-slate-700">Dữ liệu đã đồng bộ</button>

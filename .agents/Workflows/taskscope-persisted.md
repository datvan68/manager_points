# Persisted taskscope reference

Use only through [taskscope.md](taskscope.md). Preserve the existing lifecycle
schema and execution-pin compatibility. Runtime briefs do not use this template.
